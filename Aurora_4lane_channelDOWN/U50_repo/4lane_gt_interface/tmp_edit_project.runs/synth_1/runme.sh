...
HD_PWD='/home/aferretti/Aurora_4lane/U50_repo/4lane_gt_interface/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Aurora_GT_intf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Aurora_GT_intf.tcl
